...
### [1.0.4] - 2025-01-20
- Added task execution logging and automatic terminal closure
- Enhanced menu display with file availability status
- Improved task monitoring and result visualization

### [1.0.3] - 2025-08-25
- Interface cleanup and terminology normalization
